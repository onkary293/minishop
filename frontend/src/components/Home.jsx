...
const Home = () => {
  const itemName = 'Vanilla Swirl Cone'
  const itemPrice = 800
  ...
  return (
    <div className="w-full mx-auto h-full">
      <div className="text-center font-raleway w-full max-w-5xl mx-auto my-6">
        <div className="font-extrabold text-transparent text-6xl my-10 bg-clip-text bg-gradient-to-r from-yellow-400 to-pink-800">
          Ice - Cream Corner{' '}
        </div>{' '}
        <div className="flex flex-col lg:flex-row justify-center items-center mx-auto w-full my-16 border-2 bg-[afcf6f6] border-slate-100 shadow-md py-4">
          ...
          <div className="flex flex-col lg:w-6/12 w-full py-8">
            ...
            <div className="flex text-slate-900 justify-center items-center mb-10">
              <span
                onClick={decrement}
                className="select-none w-auto px-4 py-2 text-5xl bg-red-100 cursor-pointer"
              >
                {' '}
                -{' '}
              </span>{' '}
              ...
              <span
                onClick={increment}
                className="select-none w-auto px-4 py-2 text-5xl bg-green-100 cursor-pointer"
              >
                {' '}
                +{' '}
              </span>{' '}
